...
lbC000DF6:          move.l   lbL00715A(pc),a5
                    tst.w    d0
                    bne.b    lbC000E0A
                    lea      lbW0071C8(pc),a6
                    jmp      (a5)
